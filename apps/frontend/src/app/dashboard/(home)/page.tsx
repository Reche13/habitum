            ...
            {activeStreaks.map((streak) => (
              ...
              >
                <div
                  ...
                  style={{
                    backgroundColor: (streak.color || "#6366f1") + "20",
                    color: streak.color || "#6366f1",
                  }}
                >
                  {streak.icon || "🔥"}
                </div>
          ...
          <details className="group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
              {habitsCompleted.map((habit) => (
                <div
                  key={habit.id}
                  className="rounded-lg border bg-background p-4 flex items-center gap-4 opacity-75"
                >
                  <div
                    className="h-12 w-12 rounded-xl flex items-center justify-center text-2xl shrink-0"
                    style={{
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="rounded-lg border bg-background p-4">
            ...
            <div className="text-2xl font-semibold">{dashboard.quickStats.totalHabits}</div>
          </div>
        </div>
      </section>
    </div>
