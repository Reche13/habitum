...
export function GoogleAuthButton() {
  ...
  const handleGoogleSignIn = () => {
    ...
    if (!clientId) {
      setError("Google OAuth not configured. Please set NEXT_PUBLIC_GOOGLE_CLIENT_ID");
      return;
    }
    ...
    try {
      ...
      window.google.accounts.id.prompt((notification: any) => {
        if (notification.isNotDisplayed()) {
          // One Tap not displayed, show error or fallback
      ...
      setError(getErrorMessage(err) || "Failed to initiate Google Sign-In");
    }
  };
  ...
  return (
    <>
      <Button
        ...
        disabled={googleAuth.isPending || !isInitialized}
      >
